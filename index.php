...
<body id=panel><center>
  <?php if(empty($name) || $action=="reset") { ?>
    ...
    <form>
      ...
      <input type=text name=name placeholder="Last Name (*)" value="<?php echo $name ?>">
  ...
  <table>
    <tr>
      <td><div id="header">
        <a href="<?php echo $resetlink ?>"><div id="logo"><img src="<?php echo $logo; ?>" alt="<?php echo "$company"; ?>"></div></a>
      </div></td>
    </tr>
    <tr>
